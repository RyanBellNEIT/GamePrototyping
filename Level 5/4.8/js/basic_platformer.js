...
function animate()
{
	...
	if (space)
	{
		player.color = "#" + randomNumberforColor();
	}
	...
	if(platform1.hitTestPoint(player.right()) && player.vx >=0 && goal.y >= 10000)
	{
		player.x--;
		player.vx = 0;
	...
	else if(platform1.hitTestPoint(player.right()) && player.vx >=0)
	{
		player.x--;
		player.vx = 0;
	}
